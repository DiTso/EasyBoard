<div id="pub[+id+]" class="eb-item">
	<div class="eb-image"><a href="[+url+]">[+image+]</a></div>
	<div class="eb-desc">
		...
		<ul class="eb-foot">
			<li id="eb-price">>Price: [+price+] € </li>
			<li id="eb-user">Autore: [+username+]</li>
			<li id="eb-parent">Category: <a href="[~[+parent+]~]">[+parentname+]</a></li>
