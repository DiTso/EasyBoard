...
// Formation of the response, for ajax requests
...
if ( isset($_GET[act]) ){
	...
	if ( $_GET[act] == "unpub" AND isset( $_GET[item_id] ) ){
		...
		$query = $modx->db->update($fields, $mod_table, "id = $item_id");
		die('<a href="#" title="Publish" onclick="ItemAjax(\'pub\', \''.$item_id.'\', \'pub\');return false">
